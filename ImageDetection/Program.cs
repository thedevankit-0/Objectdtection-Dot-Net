...
namespace ImageDetection
{
    class Program
    {
        ...
        static readonly string _assetsPath = Path.Combine("D:\\MACHINE LEARNING\\Wroking Examples\\ImageDetection - Copy\\ImageDetection\\assets\\");
        ...
        static readonly string _predictSingleImage = Path.Combine(_assetsPath, "inputs-predict-single", "data", "PersonWithGun.jpg");
